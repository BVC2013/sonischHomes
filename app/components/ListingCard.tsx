...
interface ListingCardProps {
  listing: MLSListing;
  onSelect: (listing: MLSListing) => void;
}
...
export default function ListingCard({ listing, onSelect }: ListingCardProps) {
  ...
  return (
    <button
      ...
      className="group bg-white rounded-2xl shadow-md hover:shadow-xl transition-all duration-300 overflow-hidden text-left cursor-pointer border border-gray-100 hover:border-blue-200 w-full"
    >
      {/* Photo */}
